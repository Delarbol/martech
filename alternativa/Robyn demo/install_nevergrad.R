...
virtualenv_remove("ensayo")
virtualenv_remove("r-reticulate")
virtualenv_create("ensayo",version = "3.9")
virtualenv_install("ensayo", "nevergrad", pip=TRUE)
# 3. use the environment created
use_virtualenv("ensayo", required = TRUE)
...
Sys.setenv(RETICULATE_PYTHON = "C:/Users/delac/OneDrive/Documentos/.virtualenvs/ensayo/Scripts/python.exe")
# 5. Check python path
...
conda_install("prueba", "numpy", pip=TRUE)
# 9. Install nevergrad
conda_install("prueba", "nevergrad", pip=TRUE)
